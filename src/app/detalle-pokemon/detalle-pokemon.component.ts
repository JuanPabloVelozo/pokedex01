...
export class DetallePokemonComponent implements OnInit, OnChanges {
  ...
  guardarPokemon() {
    // guarda los datos del Pokémon en el servicio
    this.pokemonDataService.setPokemonData(this.selectedPokemon);
    this.botonTexto = 'Eliminar y guardar este Pokemon';
  }
  ...
  ngOnInit(): void {
    ...
    this.checkGender(); // Verificar el genero al cargar el componente  
  }
